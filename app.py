...
def generar_publicacion_completa_con_ia(tipo_prenda, marca, color, talla, estado, caracteristicas):
    ...
    2. "titulo": Crea un título coherente y atractivo con un MÁXIMO de 7 palabras. Debe incluir el tipo de prenda ('{tipo_prenda}'), una característica principal extraída de las características extra, y la marca ('{marca}'). Reglas importantes: NO incluyas el color. La marca debe ir SIEMPRE EN MAYÚSCULAS.
    3. "descripcion_gotrendier": Crea una descripción chic, juvenil y persuasiva para GoTrendier. Debe ser concisa y tener un MÁXIMO estricto de 55 palabras.
